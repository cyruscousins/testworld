...
public class Noise{
	...
	public static SVF2D noiseSVF(int width, float mapSize, float min, float max){
            
		return new MappedSVF2D(genNoise2f(width, .92f, 30, 31, 1, 1, min, max), width, mapSize);
